...
<img style="-webkit-user-select: none;" src="https://github.com/hankelvin/hankelvin.github.io/blob/master/_screenshots/tweets%20dataset.png">
...
Transfer learning using GloVe model trained on a Twitter corpus 
